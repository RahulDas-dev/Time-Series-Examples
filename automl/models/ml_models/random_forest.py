    ...
    def hyper_parameters(self):
        if self.has_exogeneous_data:
            ...
            param_grid = {
                ...
                "reducer__estimator__n_estimators": randint(10, 100),
                "reducer__estimator__criterion": ["mse", "mae"],
                "reducer__estimator__max_depth": randint(1, 10),
                "reducer__estimator__min_samples_split": randint(2, 20),
                "reducer__estimator__min_samples_leaf": randint(1, 20),
                "reducer__estimator__max_features": ["auto", "sqrt", "log2"],
            }
        return param_grid
